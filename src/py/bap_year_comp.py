...
# Plot English Baptism Count Comparison
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(output_path, 'bap_year_comp_jp.png'))
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(output_path, 'bap_year_comp_pred_en.png'))
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(output_path, 'bap_year_comp_pred_jp.png'))
plt.close()